...
12. [Драйвера](#Драйвера)
13. [Автор](#Автор)
14. [Благодарность](#Благодарность)
...
| Путь | Минусы | Плюсы |
|:----:|:------|:------|
| Замена материнской платы | - Нужны навыки пайки или обжимания клемм, совместимых с платой, на которую вы будете менять<br>- Придется докупать бп на 24в, твердотельные реле для работы сушки, саму плату<br>- В ace достаточно мало места для этого всего, придется выносить на корпус | - Есть возможность вернуться обратно, если вам не понравится hh |
| Прошивка стоковой платы swd или dfu | - На данный момент есть дамп только для платы 0.0.8(спасибо @sanakess), для 0.0.9 обратного пути нету<br> | - Нужны вложения только на st link(2$) |
...
# Благодарность
   ...
   Снял дамп с платы 0.0.8
   
   - [@sanakess](https://web.telegram.org/k/#@sanakess)
