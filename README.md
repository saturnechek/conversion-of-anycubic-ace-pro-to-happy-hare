...
Данная статья посвящена переводу anycubic ace pro на happy hare. Статья подразумевает, что у вас уже установлен klipper, web ui, а также умеете подключаться к хосту по ssh, и вы имеете представление о stm32, klipper.
...
9. [Замена родной материнской платы](#Замена-родной-материнской-платы)
10. [Установка и настройка happy hare](#Установка-и-настройка-Happy-Hare)
11. [Установка и настройка happy hare](#Мое-наработки-и-мысли)
12. [Благодарность и ссылки](#Благодарность-и-ссылки)
13. [Автор](#Автор)
...
- [ ] Итоговая настройка конфигурации happy hare для ace pro
...
9) Дальше есть несколько путей подключения:
    ...
    3) Припаяться к пинам и вывести удобный для вас разъем
...
# Замена родной материнской платы

   __COMING SOON__
   
   
   Ждем пока [@niknikdm](https://web.telegram.org/k/#@niknikdm) найдет время для описания данной процедуры
...
# Благодарность и ссылки
   Фотографии ace pro взяты отсюда:
   
   1) - https://github.com/printers-for-people/ACEResearch
     
   Реализует способ с заменой платы
   
   1) - [@niknikdm](https://web.telegram.org/k/#@niknikdm)

   Happy hare 
   1) - https://github.com/moggieuk/Happy-Hare
