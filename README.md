...
| Прошивка стоковой платы swd или dfu | - На данный момент есть дамп только для платы 0.0.8, для 0.0.9 обратного пути нету<br> | - Нужны вложения только на st link(2$) |
